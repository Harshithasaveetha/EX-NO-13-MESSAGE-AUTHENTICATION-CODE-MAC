...
char mac[MAC_SIZE + 1]; // BuƯer for MAC (+1 for null terminator)
char receivedMAC[MAC_SIZE + 1]; // BuƯer for input of received MAC
...
```
## Output:
<img width="751" height="383" alt="image" src="https://github.com/user-attachments/assets/ccd84ac4-e289-4f23-8c08-26fb4d6a75ef" />
